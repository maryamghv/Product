...
import ir.store.product.service.CategoryService;
...
/**
 * REST controller for managing {@link ir.store.product.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    private static final String ENTITY_NAME = "storeMicroserviceCategory";
