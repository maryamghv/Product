...
import ir.store.product.service.ProductService;
...
/**
 * REST controller for managing {@link ir.store.product.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    private static final String ENTITY_NAME = "storeMicroserviceProduct";
