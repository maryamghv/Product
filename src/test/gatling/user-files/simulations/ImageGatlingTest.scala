...
class ImageGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Image entity")
        ...
        .repeat(2) {
            ...
            .get("/services/storemicroservice/api/images")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new image")
            .post("/services/storemicroservice/api/images")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/storemicroservice${new_image_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created image")
            .delete("/services/storemicroservice${new_image_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
